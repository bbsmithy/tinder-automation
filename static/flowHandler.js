...
var screens = {
	facebookLogin: function(){return '<div class="jumbotron">\
					<div class="class="form-group">\
						...
						<input type="text" name="password" placeholder="Enter facebook password" id="fb_password" />\
						<button class="btn btn-success login-btn" onclick="login()">Login</button>\
					</div>\
	...
	phoneLogin: function(){
		return '<div class="jumbotron">\
					<div class="class="form-group">\
    					...
    					<input type="text" name="number" placeholder="Enter phone number" id="phoneNumber" />\
						<button class="btn btn-success login-btn" onclick="authPhoneNumber()">Send Number</button>\
						<div id="phoneAuthCodeSection" class="hidden">\
							<input type="text" name="code" placeholder="Enter code sent to you" id="codeNumber" />\
							<button class="btn btn-success login-btn" onclick="sendAuthCode()">Send Code</button>\
						</div>\
					</div>\
					<div class="switch-btn">\
